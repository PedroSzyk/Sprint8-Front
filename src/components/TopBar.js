	...
	return (
		<React.Fragment>
			...
			<nav className="navbar navbar-expand navbar-light bg-white topbar static-top shadow" style={{ marginBottom: 5 + 'px' }}>
				...
				<a className="sidebar-brand d-flex align-items-center justify-content-center" href="/" style={{ width: 5 + '%' }}>
				...
				<ul className="navbar-nav ml-auto">
					...
					<li className="nav-item dropdown no-arrow">
						<a className="nav-link dropdown-toggle" href="/" id="userDropdown">
							<span className="mr-2 d-none d-lg-inline text-gray-600 small">Ricky Fort</span>
